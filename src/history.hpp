...
using PawnHistory = std::array<std::array<std::array<std::array<i32, 64>, 6>, 2048>, 2>;
...
constexpr u64 PAWN_HISTORY_ENTRY_NB           = 2048;
...
public:
    ...
    i32  get_pawn_stats(const Position& pos, Move move) const;
    ...
    void update_pawn_stats(const Position& pos, Move move, i32 bonus);
