...
void print_params() {
    ...
    print_sigmoid("SAME_SIDE_KS_ACTIVATION", SAME_SIDE_KS_ACTIVATION, 32);

    print_sigmoid("OPP_SIDE_KS_ACTIVATION", OPP_SIDE_KS_ACTIVATION, 32);

    print_sigmoid("OCOS_C_SIDE_KS_ACTIVATION", OCOS_C_SIDE_KS_ACTIVATION, 32);

    print_sigmoid("OCOS_S_SIDE_KS_ACTIVATION", OCOS_S_SIDE_KS_ACTIVATION, 32);
