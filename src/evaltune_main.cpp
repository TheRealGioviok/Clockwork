...
void print_params() {
    ...
    std::cout << "inline const PParam OUTPOST_KNIGHT_UNDEFENDED_VAL    = "
              << OUTPOST_KNIGHT_UNDEFENDED_VAL << ";" << std::endl;
    std::cout << "inline const PParam OUTPOST_BISHOP_UNDEFENDED_VAL    = "
              << OUTPOST_BISHOP_UNDEFENDED_VAL << ";" << std::endl;

    std::cout << "inline const PParam OUTPOST_KNIGHT_DEFENDED_VAL    = "
              << OUTPOST_KNIGHT_DEFENDED_VAL << ";" << std::endl;
    std::cout << "inline const PParam OUTPOST_BISHOP_DEFENDED_VAL    = "
              << OUTPOST_BISHOP_DEFENDED_VAL << ";" << std::endl;
