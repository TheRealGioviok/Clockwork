...
inline const std::array<PParam, 6> PAWN_PHALANX = {
    S(21, 18), S(62, 30), S(77, 70), S(186, 145), S(538, 261), S(943, 1138),
};
...
inline const std::array<PParam, 6> BLOCKED_PASSED_PAWN = {
    S(13, -43), S(-1, 6), S(-3, -22), S(4, -44), S(-3, -89), S(-212, -130),
};
...
inline const std::array<PParam, 28> QUEEN_MOBILITY = {
    S(33, 23), S(533, -121), S(623, 34), S(676, 238), S(682, 444), S(718, 550), S(721, 660), S(746, 673), S(749, 728), S(761, 753), S(770, 778), S(775, 792), S(793, 784), S(803, 794), S(809, 788), S(822, 783), S(828, 773), S(828, 779), S(852, 735), S(875, 696), S(891, 676), S(936, 608), S(948, 600), S(1112, 421), S(1149, 376), S(1384, 224), S(1209, 310), S(1455, 177),
};
inline const std::array<PParam, 9> KING_MOBILITY = {
    S(647, -106), S(254, -192), S(123, -85), S(86, -36), S(37, -19), S(-26, 6), S(-73, 47), S(-121, 69), S(-155, 47),
};
...
inline const std::array<PParam, 48> PAWN_PSQT = {
    ...
    S(81, 78),      S(140, 86),     S(89, 134),     S(65, 132),     S(45, 122),     S(9, 118),      S(-10, 132),    S(-32, 124),    //
...
inline const std::array<PParam, 64> KNIGHT_PSQT = {
    ...
    S(112, 120),    S(179, 133),    S(273, 72),     S(220, 135),    S(227, 139),    S(158, 121),    S(116, 128),    S(96, 82),      //
    ...
    S(143, 104),    S(166, 77),     S(147, 85),     S(145, 105),    S(133, 98),     S(105, 78),     S(118, 63),     S(60, -7),      //
...
inline const std::array<PParam, 64> ROOK_PSQT = {
    ...
    S(172, 318),    S(274, 257),    S(295, 274),    S(297, 279),    S(293, 282),    S(273, 298),    S(255, 274),    S(223, 291),    //
    S(208, 317),    S(237, 324),    S(291, 290),    S(313, 274),    S(301, 288),    S(289, 299),    S(274, 291),    S(256, 307),    //
};
inline const std::array<PParam, 64> QUEEN_PSQT = {
    S(585, 579),    S(624, 541),    S(622, 549),    S(498, 680),    S(570, 597),    S(524, 620),    S(599, 534),    S(535, 563),    //
    ...
    S(567, 337),    S(606, 245),    S(600, 368),    S(613, 433),    S(586, 457),    S(604, 391),    S(579, 454),    S(559, 454),    //
    S(513, 426),    S(577, 175),    S(582, 174),    S(608, 258),    S(609, 352),    S(610, 305),    S(597, 347),    S(542, 424),    //
};
inline const std::array<PParam, 64> KING_PSQT = {
    ...
    S(-64, 89),     S(186, 73),     S(254, 32),     S(232, -10),    S(0, 0),        S(0, 0),        S(0, 0),        S(0, 0),        //
