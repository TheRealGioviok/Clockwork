...
inline const std::array<PScore, 48> PAWN_PSQT = {
    ...
    S(-74, -187),   S(28, -191),    S(-14, -164),   S(-20, -155),   S(-58, -157),   S(-96, -149),   S(-102, -133),  S(-150, -144),  //
...
inline const std::array<PScore, 64> KNIGHT_PSQT = {
    ...
    S(14, -37),     S(5, -9),       S(30, -34),     S(17, 8),       S(-2, 20),      S(-6, -14),     S(-12, -21),    S(-28, -122),   //
...
inline const std::array<PScore, 64> QUEEN_PSQT = {
    ...
    S(30, -153),    S(-18, -404),   S(-21, -254),   S(26, -196),    S(86, -215),    S(88, -274),    S(61, -183),    S(29, -100),    //
};
