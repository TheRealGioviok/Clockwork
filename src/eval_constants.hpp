...
inline const PParam KS_FLANK_ATTACK = S(5, -12);
inline const PParam KS_FLANK_DEFENSE = S(-7, -3);
inline const PParam KS_FLANK_DOUBLE_ATTACK   = S(9, -8);
inline const PParam KS_FLANK_DOUBLE_DEFENSE  = S(-7, 4);
