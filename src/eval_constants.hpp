...
inline const std::array<PScore, 9> KNIGHT_MOBILITY = {
    S(-117, -279), S(-49, -135), S(11, -56), S(54, -19), S(109, -4), S(145, 22), S(196, 5), S(235, -3), S(294, -88),
};
...
inline const std::array<PScore, 48> PAWN_PSQT = {
    ...
    S(-85, -184),   S(47, -190),    S(-2, -168),    S(-14, -159),   S(-51, -163),   S(-98, -155),   S(-110, -120),  S(-169, -142),  //
    S(-126, -169),  S(54, -173),    S(9, -149),     S(-36, -124),   S(-86, -118),   S(-110, -117),  S(-102, -102),  S(-205, -108),  //
};
inline const std::array<PScore, 64> KNIGHT_PSQT = {
    S(-389, -48),   S(-204, 38),    S(-605, 234),   S(155, -40),    S(-1, 7),       S(-463, 76),    S(-354, 65),    S(-507, 19),    //
...
inline const std::array<PScore, 64> BISHOP_PSQT = {
    ...
    S(41, -25),     S(92, 21),      S(133, 31),     S(144, 58),     S(183, 32),     S(98, 18),      S(74, 19),      S(8, -10),      //
    S(87, -63),     S(64, 0),       S(93, 20),      S(138, 32),     S(123, 43),     S(70, 39),      S(30, 7),       S(56, -60),     //
    S(68, -20),     S(119, -24),    S(122, -16),    S(62, 38),      S(70, 25),      S(55, 31),      S(110, -19),    S(41, -24),     //
...
inline const std::array<PScore, 64> ROOK_PSQT = {
    ...
    S(99, 79),      S(87, 84),      S(245, 38),     S(256, 10),     S(295, -17),    S(189, 39),     S(81, 73),      S(90, 69),      //
...
inline const std::array<PScore, 64> QUEEN_PSQT = {
    ...
    S(58, 108),     S(-36, 226),    S(46, 234),     S(-113, 315),   S(-92, 279),    S(-62, 230),    S(-65, 176),    S(-4, 81),      //
