...
inline const PParam BISHOP_MAT = S(1251, 973);
inline const PParam ROOK_MAT   = S(1701, 1711);
inline const PParam QUEEN_MAT  = S(3664, 2925);
...
inline const std::array<PParam, 5> DEFENDED_PAWN = {
    S(64, 43), S(61, 31), S(67, 57), S(146, 120), S(687, -89)
};
...
inline const std::array<PParam, 6> BLOCKED_PASSED_PAWN = {
    S(15, -46), S(3, 2), S(0, -27), S(7, -47), S(4, -96), S(-191, -146)
};

inline const std::array<PParam, 8> FRIENDLY_KING_PASSED_PAWN_DISTANCE = {
    CS(0, 0), S(12, 100), S(-21, 88), S(-13, 36), S(0, 7), S(9, 12), S(39, 9), S(18, -2)
};
...
inline const std::array<PParam, 14> BISHOP_MOBILITY = {
    S(-258, -291), S(-183, -107), S(-108, -44), S(-73, 5), S(-42, 36), S(-25, 57), S(-6, 71), S(13, 76),
    S(32, 80), S(46, 76), S(71, 62), S(136, 16), S(167, -5), S(228, -38)
};
...
inline const std::array<PParam, 28> QUEEN_MOBILITY = {
    ...
    S(336, -150), S(489, -245), S(201, -84), S(230, -108)
};
inline const std::array<PParam, 9> KING_MOBILITY = {
    S(381, 61), S(83, -112), S(-21, -21), S(-36, 15), S(-63, 19), S(-97, 24), S(-75, 26), S(-85, 20),
    S(-86, -28)
};
...
inline const std::array<PParam, 48> PAWN_PSQT = {
    ...
    S(63, 35), S(175, 63), S(152, 5), S(153, -53), S(107, -70), S(51, -21), S(12, 27), S(-38, 30),
    S(-18, 2), S(1, 5), S(18, -39), S(5, -54), S(-12, -57), S(-55, -51), S(-95, -3), S(-121, 18),
    S(-44, -47), S(-26, -18), S(-31, -52), S(-49, -49), S(-75, -58), S(-95, -50), S(-145, 0), S(-163, -12),
    S(-46, -76), S(17, -73), S(-33, -30), S(-64, -28), S(-85, -37), S(-123, -38), S(-141, -25), S(-165, -31),
...
inline const std::array<PParam, 64> KNIGHT_PSQT = {
    ...
    S(5, -2), S(71, 11), S(172, -57), S(117, 9), S(119, 16), S(58, -9), S(-2, 11), S(-21, -35),
    ...
    S(106, -14), S(131, -16), S(125, 10), S(98, 26), S(89, 35), S(85, 29), S(59, 1), S(44, -55),
...
inline const std::array<PParam, 64> BISHOP_PSQT = {
    S(-173, 68), S(-194, 49), S(-436, 76), S(-316, 89), S(-267, 93), S(-434, 118), S(-177, 96), S(-130, 70),
    S(-2, -45), S(-18, 34), S(0, 15), S(-20, 19), S(-43, 34), S(-8, 26), S(-28, 16), S(-65, 17),
    ...
    S(41, -68), S(28, -22), S(32, -15), S(43, -50), S(52, -60), S(48, -19), S(40, -47), S(22, -50)
};
inline const std::array<PParam, 64> ROOK_PSQT = {
    S(108, 5), S(174, 3), S(103, 34), S(103, 28), S(111, 17), S(59, 30), S(66, 33), S(74, 38),
    S(17, 62), S(104, 37), S(178, 15), S(103, 58), S(119, 46), S(67, 55), S(7, 73), S(-2, 79),
...
inline const std::array<PParam, 64> KING_PSQT = {
    ...
    S(-41, 52), S(62, 130), S(102, 99), S(86, 54), S(16, -16), S(16, -16), S(16, -16), S(16, -16),
    ...
    S(76, -88), S(129, -47), S(41, -2), S(-39, 42), S(16, -16), S(16, -16), S(16, -16), S(16, -16),
    S(-46, -116), S(82, -106), S(-17, -70), S(-34, -69), S(16, -16), S(16, -16), S(16, -16), S(16, -16)
};
// Epoch duration: 76.5947s
// clang-format on
}  // namespace Clockwork
