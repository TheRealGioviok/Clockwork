...
// clang-format off
inline const PParam PAWN_MAT   = S(184, 168);
inline const PParam KNIGHT_MAT = S(844, 634);
inline const PParam BISHOP_MAT = S(863, 581);
inline const PParam ROOK_MAT   = S(753, 718);
inline const PParam QUEEN_MAT  = S(1724, 1232);
...
inline const PParam KNIGHT_PROTECTOR = S(-25, -14);
...
inline const std::array<PParam, 6> PAWN_PHALANX = {
    S(20, 20), S(63, 31), S(73, 71), S(187, 143), S(545, 252), S(789, 888),
};
inline const std::array<PParam, 5> DEFENDED_PAWN = {
    S(63, 43), S(60, 32), S(66, 58), S(146, 122), S(667, -76),
};
inline const std::array<PParam, 6> PASSED_PAWN = {
    S(-69, -98), S(-59, -80), S(-33, -4), S(22, 76), S(44, 217), S(285, 308),
};
inline const std::array<PParam, 6> DEFENDED_PASSED_PUSH = {
    S(50, -45), S(36, -7), S(21, 27), S(24, 75), S(90, 153), S(147, 295),
};
...
inline const std::array<PParam, 14> BISHOP_MOBILITY = {
    S(43, -65), S(116, 119), S(191, 183), S(227, 233), S(258, 265), S(275, 287), S(295, 301), S(314, 308), S(333, 312), S(347, 309), S(373, 297), S(437, 252), S(469, 229), S(528, 197),
};
inline const std::array<PParam, 15> ROOK_MOBILITY = {
    S(170, 256), S(311, 429), S(360, 493), S(392, 503), S(420, 527), S(433, 550), S(450, 562), S(469, 569), S(485, 582), S(502, 591), S(520, 593), S(531, 596), S(551, 599), S(563, 586), S(709, 457),
};
inline const std::array<PParam, 28> QUEEN_MOBILITY = {
    S(1, 3), S(789, 345), S(889, 445), S(947, 621), S(956, 821), S(996, 918), S(1001, 1025), S(1026, 1037), S(1031, 1091), S(1043, 1116), S(1052, 1139), S(1058, 1153), S(1077, 1144), S(1088, 1155), S(1095, 1149), S(1109, 1144), S(1116, 1134), S(1117, 1139), S(1145, 1092), S(1169, 1052), S(1187, 1030), S(1243, 952), S(1258, 940), S(1408, 773), S(1401, 759), S(1439, 736), S(1172, 869), S(1116, 869),
};
...
inline const std::array<PParam, 6> QUEEN_KING_RING = {
    S(0, 0), S(-40, 34), S(-62, 49), S(-12, 8), S(137, -68), S(299, -186),
};

inline const PParam PAWN_THREAT_KNIGHT = S(239, 57);
inline const PParam PAWN_THREAT_BISHOP = S(205, 103);
...
inline const std::array<PParam, 9> BISHOP_PAWNS = {
    S(-1, -11), S(-3, -6), S(-3, -15), S(-8, -26), S(-14, -32), S(-19, -39), S(-21, -45), S(-27, -40), S(-36, -46),
};
...
inline const std::array<PParam, 48> PAWN_PSQT = {
    ...
    S(103, 159),    S(123, 163),    S(140, 119),    S(128, 105),    S(110, 101),    S(68, 107),     S(27, 154),     S(1, 175),      //
...
inline const std::array<PParam, 64> KNIGHT_PSQT = {
    S(-174, 3),     S(-129, 211),   S(-244, 399),   S(83, 228),     S(-44, 253),    S(-118, 260),   S(-345, 244),   S(-313, 149),   //
    ...
    S(56, 60),      S(84, 97),      S(88, 74),      S(111, 87),     S(117, 103),    S(97, 87),      S(108, 123),    S(85, 84),      //
};
inline const std::array<PParam, 64> BISHOP_PSQT = {
    ...
    S(190, 154),    S(205, 184),    S(239, 185),    S(238, 210),    S(244, 213),    S(186, 216),    S(188, 197),    S(156, 211),    //
    S(173, 125),    S(179, 160),    S(190, 175),    S(189, 200),    S(184, 220),    S(157, 216),    S(157, 184),    S(170, 147),    //
    S(171, 135),    S(205, 146),    S(211, 159),    S(156, 202),    S(151, 210),    S(168, 210),    S(214, 171),    S(200, 154),    //
    S(151, 101),    S(191, 120),    S(160, 136),    S(145, 166),    S(151, 153),    S(171, 147),    S(170, 166),    S(207, 107),    //
...
inline const std::array<PParam, 64> ROOK_PSQT = {
    ...
    S(472, 521),    S(620, 481),    S(648, 476),    S(648, 472),    S(603, 481),    S(530, 522),    S(546, 510),    S(427, 560),    //
    S(440, 516),    S(517, 509),    S(547, 501),    S(569, 465),    S(538, 488),    S(477, 536),    S(458, 536),    S(388, 543),    //
    S(377, 465),    S(458, 471),    S(443, 489),    S(426, 490),    S(421, 487),    S(402, 527),    S(373, 523),    S(354, 512),    //
...
inline const std::array<PParam, 64> QUEEN_PSQT = {
    S(826, 855),    S(873, 814),    S(885, 821),    S(764, 956),    S(828, 881),    S(766, 911),    S(822, 833),    S(757, 857),    //
    S(794, 915),    S(722, 1011),   S(719, 1073),   S(639, 1099),   S(663, 1050),   S(646, 1051),   S(694, 956),    S(730, 891),    //
    S(756, 948),    S(841, 952),    S(785, 1029),   S(767, 1044),   S(725, 1026),   S(692, 1025),   S(761, 916),    S(728, 885),    //
    S(818, 870),    S(822, 940),    S(785, 978),    S(773, 1048),   S(750, 1034),   S(741, 964),    S(778, 870),    S(767, 832),    //
    S(781, 898),    S(815, 862),    S(789, 937),    S(748, 997),    S(735, 986),    S(742, 939),    S(754, 858),    S(757, 806),    //
    S(788, 747),    S(815, 789),    S(815, 860),    S(761, 889),    S(772, 846),    S(776, 850),    S(787, 777),    S(764, 780),    //
    S(768, 649),    S(806, 543),    S(795, 677),    S(812, 750),    S(786, 768),    S(802, 698),    S(777, 759),    S(760, 758),    //
    S(708, 734),    S(765, 494),    S(776, 481),    S(804, 573),    S(806, 657),    S(809, 613),    S(797, 650),    S(746, 721),    //
};
inline const std::array<PParam, 64> KING_PSQT = {
    ...
    S(-18, -108),   S(84, -89),     S(-47, -47),    S(-82, -44),    S(0, 0),        S(0, 0),        S(0, 0),        S(0, 0),        //
};

// Epoch duration: 7.15683s
// clang-format on
}  // namespace Clockwork
