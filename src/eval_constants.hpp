...
inline const std::array<PParam, 9> KING_MOBILITY = {
    S(502, 552), S(27, 329), S(-13, 462), S(-18, 476), S(-5, 483), S(-17, 475), S(6, 476), S(19, 461), S(34, 422),
};
...
inline const std::array<PParam, 48> PAWN_PSQT = {
    ...
    S(-34, -122),   S(-15, -93),    S(-21, -128),   S(-37, -127),   S(-56, -139),   S(-77, -128),   S(-129, -79),   S(-151, -91),   //
...
inline const std::array<PParam, 64> KNIGHT_PSQT = {
    ...
    S(63, -7),      S(99, 40),      S(183, 24),     S(143, 39),     S(152, 27),     S(58, 36),      S(62, 21),      S(-35, 35),     //
    ...
    S(-43, -48),    S(-16, -21),    S(-3, -35),     S(8, -22),      S(4, -14),      S(-45, -48),    S(-62, -27),    S(-82, -72),    //
};
inline const std::array<PParam, 64> BISHOP_PSQT = {
    ...
    S(59, 51),      S(113, 50),     S(221, 40),     S(132, 41),     S(120, 42),     S(87, 59),      S(136, 35),     S(28, 50),      //
    S(76, 1),       S(72, 60),      S(126, 49),     S(137, 75),     S(141, 75),     S(74, 73),      S(51, 55),      S(10, 39),      //
    S(77, -21),     S(89, 14),      S(94, 41),      S(100, 61),     S(91, 83),      S(54, 68),      S(36, 28),      S(34, -26),     //
    ...
    S(91, -19),     S(60, 4),       S(48, 2),       S(72, -33),     S(82, -41),     S(77, -9),      S(69, -22),     S(74, -3),      //
};
inline const std::array<PParam, 64> ROOK_PSQT = {
    ...
    S(-153, 14),    S(-57, -38),    S(-30, -30),    S(-13, -34),    S(-18, -29),    S(-33, -16),    S(-52, -35),    S(-97, -17),    //
...
inline const std::array<PParam, 64> QUEEN_PSQT = {
    ...
    S(53, 112),     S(-30, 207),    S(-35, 268),    S(-106, 287),   S(-90, 235),    S(-113, 252),   S(-46, 143),    S(-4, 73),      //
    ...
    S(19, -182),    S(44, -282),    S(27, -131),    S(49, -59),     S(21, -40),     S(42, -117),    S(23, -54),     S(12, -57),     //
