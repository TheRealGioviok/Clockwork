...
inline const std::array<PScore, 6> PAWN_PHALANX = {
    S(14, -16), S(9, 16), S(66, 53), S(169, 159), S(729, 444), S(1156, 1334),
};
...
inline const std::array<PScore, 15> ROOK_MOBILITY = {
    S(-359, -391), S(-125, -116), S(-54, -62), S(-20, -47), S(22, -26), S(51, -11), S(77, 9), S(104, 4), S(135, 5), S(167, 12), S(207, 4), S(245, -2), S(278, -9), S(303, -22), S(523, -202),
};
inline const std::array<PScore, 28> QUEEN_MOBILITY = {
    S(-463, 19), S(-443, 32), S(-143, -283), S(-100, -375), S(-86, -327), S(-73, -238), S(-58, -147), S(-40, -98), S(-29, -48), S(-11, -31), S(-2, -6), S(5, 19), S(22, 19), S(25, 39), S(36, 37), S(31, 51), S(52, 14), S(66, 0), S(89, -28), S(107, -63), S(169, -134), S(215, -201), S(286, -259), S(397, -380), S(494, -478), S(706, -633), S(843, -774), S(1225, -883),
};
...
inline const std::array<PScore, 48> PAWN_PSQT = {
    ...
    S(-18, 78),     S(103, 121),    S(113, 65),     S(132, 10),     S(113, -24),    S(49, 16),      S(27, 57),      S(-83, 66),     //
    S(-111, -56),   S(-20, -71),    S(0, -110),     S(3, -135),     S(-16, -137),   S(-74, -113),   S(-89, -75),    S(-162, -49),   //
    S(-115, -141),  S(-45, -128),   S(-13, -171),   S(-23, -170),   S(-38, -180),   S(-89, -151),   S(-140, -100),  S(-198, -105),  //
    S(-85, -184),   S(47, -190),    S(-2, -169),    S(-14, -159),   S(-51, -163),   S(-98, -155),   S(-110, -120),  S(-169, -142),  //
...
inline const std::array<PScore, 64> BISHOP_PSQT = {
    S(0, 14),       S(-149, 52),    S(-520, 107),   S(-108, 30),    S(-196, 69),    S(-274, 76),    S(-215, 143),   S(-90, 87),     //
    S(-15, 23),     S(12, 36),      S(69, 4),       S(23, -11),     S(-27, 33),     S(14, 24),      S(51, 7),       S(-25, 21),     //
    S(59, -5),      S(123, 30),     S(201, 19),     S(209, -2),     S(167, 7),      S(138, 26),     S(90, 6),       S(19, -15),     //
    S(41, -25),     S(92, 21),      S(133, 31),     S(144, 58),     S(183, 32),     S(97, 18),      S(74, 19),      S(8, -10),      //
    S(87, -63),     S(64, 0),       S(93, 20),      S(138, 32),     S(123, 43),     S(70, 39),      S(30, 7),       S(56, -60),     //
    S(68, -20),     S(120, -24),    S(122, -16),    S(62, 38),      S(70, 25),      S(55, 31),      S(110, -19),    S(41, -24),     //
...
inline const std::array<PScore, 64> QUEEN_PSQT = {
    ...
    S(57, 108),     S(-35, 226),    S(46, 234),     S(-113, 315),   S(-92, 279),    S(-62, 230),    S(-65, 176),    S(-3, 81),      //
