...
#define CLOCKWORK_TUNABLES(TUNE, NO_TUNE)                         \
    ...
    NO_TUNE(bmstability0, 1750, 1250, 5000, 188, 0.002)           \
    NO_TUNE(bmstability1, 1000, 600, 2400, 90, 0.002)             \
    NO_TUNE(bmstability2, 900, 462, 1850, 69, 0.002)              \
    NO_TUNE(bmstability3, 825, 408, 1630, 61, 0.002)              \
    NO_TUNE(bmstability4, 775, 363, 1450, 54, 0.002)              \
                                                                  \
    /* End of Tunables */
